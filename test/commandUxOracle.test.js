...
const COMMANDS = Object.freeze([
  ...
  ["cloudsmith-vsc.pullDependencies", "Pull dependencies", "global", true, "cloudsmith.connected && cloudsmith.pullThroughAvailable && cloudsmith.depScanSucceeded && !cloudsmith.depOperationRunning"],
  ["cloudsmith-vsc.pullSingleDependency", "Pull dependency", "context-only", false, "cloudsmith.connected && cloudsmith.pullThroughAvailable && cloudsmith.depScanSucceeded && !cloudsmith.depOperationRunning"],
...
const ITEM_PLACEMENTS = Object.freeze([
  ["cloudsmith-vsc.inspectPackage", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.inspect(?:\\.|$)/", "navigation"],
  ...
  ["cloudsmith-vsc.openPackage", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.open(?:\\.|$)/", "navigation"],
  ...
  ["cloudsmith-vsc.inspectPackage", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.inspect(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.openPackage", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.open(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.inspectPackage", "view == cloudsmithDependencyHealthView && viewItem =~ /^dependencyHealthActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.inspect(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.openPackage", "view == cloudsmithDependencyHealthView && viewItem =~ /^dependencyHealthActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.open(?:\\.|$)/", "navigation"],
  ...
  ["cloudsmith-vsc.findSafeVersion", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.findSafeVersion(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.findSafeVersion", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.findSafeVersion(?:\\.|$)/", "navigation"],
  ...
  ["cloudsmith-vsc.showVulnerabilities", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.showVulnerabilities(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.showVulnerabilities", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.showVulnerabilities(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.showDepVulnerabilities", "view == cloudsmithDependencyHealthView && viewItem =~ /^dependencyHealthActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.showVulnerabilities(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.findDepSafeVersion", "view == cloudsmithDependencyHealthView && viewItem =~ /^dependencyHealthActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.findSafeVersion(?:\\.|$)/", "navigation"],
  ...
  ["cloudsmith-vsc.explainQuarantine", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.explainQuarantine(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.explainQuarantine", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.explainQuarantine(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.explainQuarantine", "view == cloudsmithDependencyHealthView && viewItem =~ /^dependencyHealthActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.explainQuarantine(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.copyInstallCommand", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.install(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.copyInstallCommand", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.install(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.copyInstallCommand", "view == cloudsmithDependencyHealthView && viewItem =~ /^dependencyHealthActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.install(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.showInstallCommand", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.install(?:\\.|$)/", "navigation"],
  ["cloudsmith-vsc.showInstallCommand", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.install(?:\\.|$)/", "navigation"],
  ...
  ["cloudsmith-vsc.showPromotionStatus", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.showPromotionStatus(?:\\.|$)/", "2_promotion"],
  ["cloudsmith-vsc.showPromotionStatus", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.showPromotionStatus(?:\\.|$)/", "2_promotion"],
  ["cloudsmith-vsc.promotePackage", "view == cloudsmithView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.promote(?:\\.|$)/", "2_promotion"],
  ["cloudsmith-vsc.promotePackage", "view == cloudsmithSearchView && viewItem =~ /^packageActions(?:\\.[A-Za-z][A-Za-z0-9]*)*\\.promote(?:\\.|$)/", "2_promotion"],
...
const TITLE_PLACEMENTS = Object.freeze([
  ...
  ["cloudsmith-vsc.pullDependencies", "view == cloudsmithDependencyHealthView && cloudsmith.connected && cloudsmith.pullThroughAvailable && cloudsmith.depScanSucceeded && !cloudsmith.depOperationRunning", "navigation@2"],
